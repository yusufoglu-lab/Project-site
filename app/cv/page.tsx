    ...
    <>
      ...
      <section className="container mx-auto grid gap-12 pb-24 lg:grid-cols-[220px_1fr] lg:gap-16">
        ...
        <div className="space-y-16">
          ...
          <CVSection id="positions" title="Academic positions">
            <ul className="space-y-5">
              {positions.map((p) => (
                <li
          ...
          <CVSection id="awards" title="Awards & honors">
          ...
          <CVSection
            ...
            description="Eight most recent. The full list is available on the publications page."
          >
            <ul className="space-y-4">
              {abbreviated.map((p) => (
          ...
          <CVSection id="grants" title="Grants & funding">
            <ul className="space-y-5">
              {grants.map((g) => (
          ...
          <CVSection id="service" title="Service & editorial">
            <ul className="space-y-4">
              {service.map((s) => (
                <li
          ...
          <CVSection id="memberships" title="Professional memberships">
